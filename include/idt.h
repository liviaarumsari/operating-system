...
/**
 * IDTGate, IDT entry that points into interrupt handler.
 ...
 * @param offset_high Upper 16-bit offset
 */
struct IDTGate {
 ...
 * @param address IDT address, IDT should already be defined properly
 */
struct IDTR {
    uint16_t size;
    struct IDT *address;
